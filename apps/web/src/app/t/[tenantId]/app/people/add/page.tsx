...
export default function AddTenantPage() {
  ...
  const [form, setForm] = React.useState<TenantForm>({ name: "", email: "", phone: "", propertyId: "", rent: "", startDate: "", endDate: "", emergencyName: "", emergencyPhone: "" });
    ...
    <div className="mx-auto grid w-full max-w-[1140px] gap-5 pb-8">
      ...
      {state === "success" ? (
        <section className="mx-auto w-full max-w-[440px] rounded-[8px] border border-[#dfe7e3] bg-white p-8 text-center">
          ...
          <p className="mt-2 text-sm text-[#71817e]">An invitation has been sent to {form.email}.</p>
