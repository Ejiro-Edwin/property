...
export function ProfileSwitcher({
  ...
  return (
    <div className="grid gap-2 px-1">
      <div className="px-2 text-xs font-medium uppercase tracking-wide text-muted">
        Operating as
      </div>
      <div className="flex flex-wrap gap-1 rounded-[12px] border border-border bg-charcoal-soft p-1">
        {visible.map((role) => {
